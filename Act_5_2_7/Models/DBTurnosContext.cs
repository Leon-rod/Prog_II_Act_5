    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<TDetallesTurno>(entity =>
        {
            ...
            entity.HasOne(d => d.IdServicioNavigation).WithMany(p => p.TDetallesTurnos)
                ...
                .HasConstraintName("FK_TDT_SERVICIOS");

            entity.HasOne(d => d.IdTurnoNavigation).WithOne(p => p.detallesTurno)
                .HasForeignKey<TDetallesTurno>(d => d.IdTurno)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TDT_TURNOS");
        });
